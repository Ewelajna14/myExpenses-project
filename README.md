# Expenses tracking app: React/Rails API

## Description
This project is a simple expense tracking app. 
User has to create username and password to being able to use the app. 
After successfull login user can create expenses for each month based on categories, 
user can increase expenses and see total amount spent every month. 
